...
;;  name          default   256          16
   ...
   (red         '("#ff0060" "#ff0060"    "red"          ))
   (orange      '("#ff6000" "#ff6000"    "brightred"    ))
   (green       '("#60ff00" "#60ff00"    "green"        ))
   (teal        '("#00ff60" "#00ff60"    "brightgreen"  ))
   (yellow      '("#ffc000" "#ffc000"    "yellow"       ))
   (pear        '("#c0ff00" "#c0ff00"    "brightyellow" ))
   (blue        '("#0060ff" "#0060ff"    "blue"         ))
   (dark-blue   '("#6000ff" "#6000ff"    "brightblue"   ))
   (violet      '("#c000ff" "#c000ff"    "magenta"      ))
   (magenta     '("#ff00c0" "#ff00c0"    "brightmagenta"))
   (dark-cyan   '("#00ffc0" "#00ffc0"    "cyan"         ))
   (cyan        '("#00c0ff" "#00c0ff"    "brightcyan"   ))
